package com.negi.ritika.admissionform.Adapter;
...
public class my_adapter extends RecyclerView.Adapter<my_adapter.MyViewHolder> {
    ...
    public my_adapter(Context context, ArrayList<Bitmap> arr) {
        ...
        objList = arr;
        Toast.makeText(context, ""+objList.size(), Toast.LENGTH_SHORT).show();
    }
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                showCourse(view, holder.getAdapterPosition());
    ...
    private void showCourse(View view, final int pos) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DataClass.docs.remove(pos);
                notifyDataSetChanged();
                new my_adapter(context, DataClass.docs);
                alertDialog.dismiss();
            }
        });
    }
